...
?>
  <form action="update.php" method="post" >
    ...
    <div class="mb-3 row">
        <label for="staticEmail" class="col-sm-2 col-form-label">CustomerID</label>
        <div class="col-sm-10">
            <input type="text" name="CustomerID" readonly class="form-control-plaintext" value="<?= $user[0] ?>">
        </div>
    </div>

    <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">CustomerName</label>
        <div class="col-sm-10">
            <input type="text" name="CustomerName" class="form-control" id="inputPassword" value="<?= $user[1]?>">
        </div>
    </div>
